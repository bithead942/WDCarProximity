...
Partial Public Class WatchdogDataSet
    ...
    Partial Public Class Event_Current_StateDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddEvent_Current_StateRow(ByVal Row_ID As Integer, ByVal House_Occupied As Integer, ByVal Last_Update As Date) As Event_Current_StateRow
            Dim rowEvent_Current_StateRow As Event_Current_StateRow = CType(Me.NewRow,Event_Current_StateRow)
            Dim columnValuesArray() As Object = New Object() {Row_ID, House_Occupied, Last_Update}
...
Namespace WatchdogDataSetTableAdapters
    ...
    Partial Public Class Event_HistoryTableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.WDCarProximity2.My.MySettings.Default.WatchdogConnectionString
        End Sub
    ...
    Partial Public Class Event_Current_StateTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [Event_Current_State] WHERE (([Row_ID] = @Original_Row_ID) AND ([Hous"& _ 
                "e_Occupied] = @Original_House_Occupied) AND ([Last_Update] = @Original_Last_Upda"& _ 
                "te))"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Event_Current_State] SET [Row_ID] = @Row_ID, [House_Occupied] = @House_Oc"& _ 
                "cupied, [Last_Update] = @Last_Update WHERE (([Row_ID] = @Original_Row_ID) AND (["& _ 
                "House_Occupied] = @Original_House_Occupied) AND ([Last_Update] = @Original_Last_"& _ 
                "Update));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Row_ID, House_Occupied, Last_Update FROM Event_Current_State W"& _ 
                "HERE (Last_Update = @Last_Update)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT        Row_ID, House_Occupied, Last_Update"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Event_Current_"& _ 
                "State"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (Row_ID = 1)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT House_Occupied, Last_Update, Row_ID FROM Event_Current_State WHERE (Row_ID"& _ 
                " = 1)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(2) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(2).Connection = Me.Connection
            Me._commandCollection(2).CommandText = "UPDATE       Event_Current_State"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SET                Geofence_Reached = 1"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE "& _ 
                "       (Row_ID = 1)"
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As WatchdogDataSet.Event_Current_StateDataTable) As Integer
        ...
        Public Overloads Overridable Function GetDataBy() As WatchdogDataSet.Event_Current_StateDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Dim dataTable As WatchdogDataSet.Event_Current_StateDataTable = New WatchdogDataSet.Event_Current_StateDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        ...
        Public Overloads Overridable Function SetGeoFence() As Integer
